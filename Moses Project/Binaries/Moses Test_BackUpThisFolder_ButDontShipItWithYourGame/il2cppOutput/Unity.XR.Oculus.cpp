...
IL_00e8:
	...
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
		Debug_LogWarning_mEF15C6B17CE4E1FA7E379CDB82CE40FCD89A3F28(_stringLiteralCD3DD4C1241990E3D05C7BE7560D9E9C10B9D7A5, NULL);
		goto IL_0151;
	}
	...
	{// begin try (depth: 1)
		{
			...
			bool L_0;
			L_0 = NativeMethods_LoadOVRPlugin_mAD776BE0CE1A3C7FC318567179EC0D4F83AE3DCD(_stringLiteralDA39A3EE5E6B4B0D3255BFEF95601890AFD80709, NULL);
			if (L_0)
			{
				goto IL_0016_1;
			}
		}
		{
			...
			il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
			Debug_LogError_m059825802BB6AF7EA9693FEBEEB0D85F59A3E38E(_stringLiteral79107CD3BE0F3FC64B9E61F6ED6F8C2C75548D4F, NULL);
		}
...
{
	{
		...
		bool L_0;
		L_0 = NativeMethods_GetAppShouldQuit_m8B8CE94E700636ED76D7E2A38B6B65E5EB77CAE9(NULL);
		if (!L_0)
		{
			goto IL_0011;
		}
